app = angular.module('TravApp', ['ngRoute', 'ngSanitize', 'ui.bootstrap', 'ui.select', 'travellerAlerts', 'travellerCharacters', 'travellerSkills', 'travellerDmSelectorTest', 'diceRoller', 'shipManagement', 'randomModule', 'decoder']) //declare the main module
...
app.config(function ($routeProvider) {
   $routeProvider
      ...
      .when("/dmSelectorTest", {controller: "dmSelectorTestController as dmSelectTest", templateUrl: "dmSelectorTest.view"})

...
var AvailablePassengers={
	low:[
		...
		function(){ return rawroll(2,6).total},// 		function(){ return 2d6",
		function(){ return rawroll(3,6).total-rawroll(1,6).total},// 		function(){ return 3d6-1d6",
		function(){ return rawroll(3,6).total-rawroll(1,6).total},// 		function(){ return 3d6-1d6",
	...
	mid:[
 		function(){ return 0},
 		function(){ return 0},
		function(){ return Math.max(rawroll(1,6).total-2)},// 		function(){ return 1d6-2",
		function(){ return rawroll(1,6).total},// 		function(){ return 1d6",
		function(){ return Math.max(rawroll(2,6).total-rawroll(1,6).total)},// 		function(){ return 2d6-1d6",
		function(){ return Math.max(rawroll(2,6).total-rawroll(1,6).total)},// 		function(){ return 2d6-1d6",
		function(){ return rawroll(2,6).total},// 		function(){ return 2d6",
		function(){ return rawroll(3,6).total-rawroll(2,6).total},// 		function(){ return 3d6-2d6",
		function(){ return rawroll(3,6).total-rawroll(1,6).total},// 		function(){ return 3d6-1d6",
		function(){ return rawroll(3,6).total-rawroll(1,6).total},// 		function(){ return 3d6-1d6",
		function(){ return rawroll(3,6).total},// 		function(){ return 3d6",
		function(){ return rawroll(4,6).total},// 		function(){ return 4d6",
	...
	high:[
 		...
 		function(){ return 0},
 		function(){ return 0},
		function(){ return Math.max(rawroll(1,6).total-rawroll(1,6).total)},// 		function(){ return 1d6-1d6",
		function(){ return Math.max(rawroll(2,6).total-rawroll(2,6).total)},// 		function(){ return 2d6-2d6",
		function(){ return Math.max(rawroll(2,6).total-rawroll(1,6).total)},// 		function(){ return 2d6-1d6",
		function(){ return Math.max(rawroll(3,6).total-rawroll(2,6).total)},// 		function(){ return 3d6-2d6",
		function(){ return Math.max(rawroll(3,6).total-rawroll(2,6).total)},// 		function(){ return 3d6-2d6",
		function(){ return Math.max(rawroll(3,6).total-rawroll(1,6).total)},// 		function(){ return 3d6-1d6",
		function(){ return Math.max(rawroll(3,6).total-rawroll(1,6).total)},// 		function(){ return 3d6-1d6",
		function(){ return Math.max(rawroll(3,6).total-rawroll(1,6).total)},// 		function(){ return 3d6-1d6",
		function(){ return rawroll(3,6).total},// 		function(){ return 3d6",
		function(){ return rawroll(3,6).total},// 		function(){ return 3d6",
